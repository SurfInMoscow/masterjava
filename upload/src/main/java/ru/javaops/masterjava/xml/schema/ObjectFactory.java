 ...
 * generated in the ru.javaops.masterjava.ru.javaops.masterjava.xml.schema package.
...
public class ObjectFactory {
    ...
    private final static QName _City_QNAME = new QName("http://vorobyev.masterjava.ru", "City");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.javaops.masterjava.ru.javaops.masterjava.xml.schema
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://vorobyev.masterjava.ru", name = "City")
